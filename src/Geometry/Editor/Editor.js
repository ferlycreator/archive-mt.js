Z.Editor=Z.Class.extend({
    ...
    createHandleDom:function(pixel,opts) {
        ...
        handle.innerHTML='<div title="'+opts.tip+'" style="display:block;width:11px;height:11px;background:url(images/dd-via.png) 0px 0px no-repeat;"></div>';
        return handle;
    },
    ...
    createPolygonEditor:function() {
        ...
        function createRemoveHandle() {
            ...
            closeHandle.innerHTML="<div title=\"点击删除端点\" style=\"display:block;width:14px;height:14px;background:url(images/close.gif) 0px 0px no-repeat;\"></div>";
